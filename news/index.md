...
- Add code() to code qualitative text entries with support of cosine
  similarity or string distance
- Add add_level() for recursive coding of qualitative text entries
- Add similarity_stringdist() to calculate similarity between character
  vectors based on string distance
- Add similarity_cosine() to calculate cosine similarity between vector
  embeddings, see get_embeddings()
