...
vignette: >
  %\VignetteIndexEntry{Making a Theory FAIR}
...
- [ ] Creating a project folder for your theory
- [ ] Version controlling this folder with Git
- [ ] Connecting the local repository to a remote (GitHub) repository
- [ ] Adding a shareable theory file to the repository
- [ ] Adding a LICENSE file to the repository (we recommend CC0)
- [ ] Adding a README file to the repository
- [ ] Adding a Zenodo metadata to the repository
- [ ] Pushing these changes to the remote repository
- [ ] Turning on Zenodo archiving for the remote repository
- [ ] Publishing a release of your theory
- [ ] Verifying that Zenodo mints a DOI for your theory and its latest release

<!-- fig.width=600, fig.height=861,  -->

```{r include = pkgdown::in_pkgdown(), eval = TRUE, echo = FALSE, fig.align='center', out.width = "70%", fig.cap="Conceptual workflow for this task."}
...
```{r  include = pkgdown::in_pkgdown(), eval = TRUE, echo = FALSE, out.width = "70%", fig.cap="Front Page of a GitHub Repository"}
...
```{r include = pkgdown::in_pkgdown(), eval = TRUE, echo = FALSE, fig.align='center', out.width = "70%", fig.cap="Sign up for Zenodo"}
...
```{r include = pkgdown::in_pkgdown(), eval = TRUE, echo = FALSE, fig.align='center', out.width = "70%", fig.cap="Authorize Zenodo to connect with GitHub"}
...
```{r include = pkgdown::in_pkgdown(), eval = TRUE, echo = FALSE, fig.align='center', out.width = "70%", fig.cap="Enable individual GitHub repositories to be archived in Zenodo"}
...
```{r include = pkgdown::in_pkgdown(), eval = TRUE, echo = FALSE, fig.align='center', out.width = "70%", fig.cap="Check that webhooks are enabled for your GitHub repository."}
...
```{r include = pkgdown::in_pkgdown(), eval = TRUE, echo = FALSE, fig.align='center', out.width = "70%", fig.cap="Check the new release has been uploaded."}
...
```{r include = pkgdown::in_pkgdown(), eval = TRUE, echo = FALSE, fig.align='center', out.width = "70%", fig.cap="Click the orange Edit button."}
