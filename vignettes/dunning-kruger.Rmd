...
To FAIRify this graph, we can use a standardized graph specification language, such as the [DOT language](https://graphviz.org/doc/info/lang.html).
...
Here we opt for a representation as latex code as a widely used and known way of typesetting equations, by saving the following code to a file "equations.tex":
...
## Common Experimental Paradigm
 ...
 - participants guess their test performance either before or after the test
 - bottom quartile performers vastly overestimate their performance, while top quartile performers access their performance more accurately
