...
This workflow can be used to split up more complex mathematical theories to keep them organized.
...
If we know render `render.tex`, the resulting document looks like this:
